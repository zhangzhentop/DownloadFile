...
//                          forState:UIControlStateNormal];
    ...
    [_infoButton setImage:[UIImage imageNamed:@"recom_share.png"] forState:UIControlStateNormal];
//    [_infoButton addTarget:self action:@selector(infoDidTouch:) forControlEvents:UIControlEventTouchUpInside];
    [_infoButton addTarget:self action:@selector(showShareActionSheet:) forControlEvents:UIControlEventTouchUpInside];
...
//- (void)openAirDrop:(id)sender {
//    [self pause];
//    NSURL *url = [NSURL fileURLWithPath:_filePath];
////    UIImage *video = [UIImage imageWithContentsOfFile:filePath];
...
//                                    UIActivityTypeCopyToPasteboard,//复制到剪切板
//                                    ];
...
- (void)showShareActionSheet:(id)sender
{
     ...
     **/
    __weak KxMovieViewController *theController = self;
